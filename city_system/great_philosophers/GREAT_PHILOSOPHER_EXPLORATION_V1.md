...
|---:|---|---|---|---|---|---|
| 1 | Francis Bacon | England | Scientific Revolution | 귀납법 | 다음 3개 Eureka가 각각 추가로 연구비 8%를 제공. Eureka를 얻을 때 Culture 30도 획득. | DRAFT |
| 2 | René Descartes | France | Astronomy | 방법서설과 해석기하 | 2 charges. 각 charge는 현재 연구 기술의 남은 비용 12%만큼 Science. University 도시에서 사용하면 Culture 40 추가. | DRAFT |
| 3 | Blaise Pascal | France | Banking | 확률과 내기 | 2 charges. Bank 또는 University 도시에서 사용해 Gold 100 + Science 70 또는 Faith 100 + Culture 70 중 하나를 선택. | DRAFT |
...
| 11 | Thomas Hobbes | England | Sovereignty | 리바이어던 | 불행 도시의 Government 계통 건물이 Production +2를 제공. 행복한 Government 도시는 Culture +2를 제공. | DRAFT |
| 12 | John Locke | England | Colonialism | 통치론과 재산권 | 새 Luxury 또는 전략자원을 처음 연결할 때 최초 4회 Culture 35, Gold 35. Market 또는 Bank 도시에서는 각 발동에 Science 20 추가. | DRAFT |
| 13 | Baruch Spinoza | Dutch Republic | Reformed Church | 에티카 | Temple이 있는 도시에서 Faith 산출량 2당 Science 1, 최대 Science +3. University도 있으면 Culture +1. | DRAFT |
| 14 | Nicolas Malebranche | France | Reformed Church | 기회원인론 | Temple과 University가 함께 있는 도시에서 다음 Eureka 1개와 Inspiration 1개가 각각 Faith 50을 추가로 제공. | DRAFT |
| 15 | Samuel Pufendorf | German lands | Sovereignty | 자연법과 국가 | 국제 교역로가 있는 Government 도시에서 새 사회제도를 완료할 때 최초 3회 Gold 50, Culture 50. | DRAFT |
| 16 | Pierre Bayle | France/Netherlands | Print Culture | 관용과 회의 | Printing Press가 있는 도시는 +2 Culture. Temple도 있는 도시는 Great Philosopher Point +1. | DRAFT |
| 17 | Wang Yangming | Ming China | Court Culture | 지행합일 | 사회제도를 완료하면 다음 도시 건물 건설에 Production 50, 최대 3회. Court가 있으면 각 발동 시 Culture 35 추가. | DRAFT |
...
| 25 | Wang Fuzhi | China | Scientific Revolution | 기와 역사 | 기술 완료 시 다음 사회제도 연구 시작 6% 진척, 사회제도 완료 시 다음 기술 6% 진척. 각각 최대 2회. | DRAFT |
| 26 | Gu Yanwu | China | Print Culture | 경세치용 | Printing Press와 Government 계통이 함께 있는 도시의 국제 교역로 +1 Culture, +1 Gold. 국내 교역로는 +1 Production. | DRAFT |
